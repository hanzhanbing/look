...
public class DownloadManage {
    ...
    public DownloadManage(Context context, String url, String name) {
    ...
    private void downloadAPK(String url, String name) {
        ...
        request.setDescription("新版商户端下载中...");
    ...
    private void installAPK() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri apkUri = FileProvider.getUriForFile(mContext, "com.xlgcx.merchant.fileprovider", file);
